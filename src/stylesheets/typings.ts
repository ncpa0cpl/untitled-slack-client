...
export interface ViewStyle extends FlexStyle, ShadowStyleIOS, TransformsStyle {
   ...
   * [elevation
   * API](https://developer.android.com/training/material/shadows-clipping.html#Elevation).
   * This adds a drop shadow to the item and affects z-order for
   * overlapping views. Only supported on Android 5.0+, has no
...
export interface TextStyle extends TextStyleIOS, TextStyleAndroid, ViewStyle {
  ...
  /**
   * Specifies font weight. The values 'normal' and 'bold' are
   * supported for most fonts. Not all fonts have a variant for
   * each of the numeric values, in that case the closest one is
   * chosen.
   */
  fontWeight?:
    | "normal"
